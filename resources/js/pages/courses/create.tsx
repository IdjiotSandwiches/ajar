...
export default function CreateCoursePage() {
    const form = useForm<CourseData>({
        ...
        category: null,
        learning_objectives: [
            { id: Date.now(), learning_objective: "" },
        ],
        benefit_for_students: [
            { id: Date.now() + 1, benefit_for_students: "" },
        ],
        benefit_for_teachers: [
            { id: Date.now() + 2, benefit_for_teachers: "" },
        ],
        course_overviews: [
            { id: Date.now() + 3, course_overview: "" },
        ],
        programming_language: [
            { id: Date.now() + 4, learning_objective: "" },
        ],
        duration: 0,
        price_for_student: 0,
        discount: 0,
                                                ...
                                                form.setData(
                                                    ...
                                                    (form.data.course_overviews ?? []).map((courseOverview) =>
                                                        courseOverview.id === cop.id
                                                            ? { ...courseOverview, course_overviews: e.target.value }
                                                            : courseOverview
                                                    )
                                                )
                                            }
