import { studentMyCoursesFilter } from '@/components/lms/filter/dictionary/student-my-courses';
...
export default function MyCourse({ filters, myCourses }: any) {
    ...
    return (
        <>
            <div className="flex min-h-screen flex-col gap-6">
                <Filter schema={studentMyCoursesFilter(filters)} onChange={onFilterChange} />
