...
export default function TeacherApplicationsPage() {
    ...
    const confirmAction = () => {
        if (selectedAction) {
            console.log(`Teacher ${selectedAction.name} ${selectedAction.type}ed.`);
    ...
    return (
        <div className="min-h-screen bg-[#f9fdfd] flex flex-col">
                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-600 text-sm mb-1">
                                                    I applied to be a Teacher at Ajar, I am a specialist in <span className="font-medium">Artificial Intelligence and Network</span>
                                                </p>
            ...
            <DynamicModal
                ...
                description={
                    selectedAction
                        ? `Are you sure you want to ${selectedAction.type === "accept" ? "accept" : "reject"
