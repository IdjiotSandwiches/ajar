    ...
    return (
        <>
            <div className="flex min-h-screen flex-col gap-6">
                <h1 className="hidden text-2xl font-semibold text-gray-800 md:flex">Institutes</h1>
...
InstituteList.layout = (page: React.ReactNode) => <LMSLayout title="Institutes">{page}</LMSLayout>;
