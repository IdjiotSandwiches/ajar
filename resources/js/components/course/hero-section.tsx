...
export default function CourseHero({ course }: { course: any }) {
    ...
    const handleConfirmApplyTeacher = () => {
        // router.post(route('teacher.apply-course', course.id));
                ...
                <div className="mx-auto mt-8 grid grid-cols-1 items-start gap-10 px-4 md:px-20 lg:grid-cols-3">
                    <div className="lg:col-span-2">
                        ...
                        <div className="mt-4 flex flex-wrap items-center gap-6">
                            {(!user || user?.role_id === roles.Student) && (
                                <button
                            ...
                            {user?.role_id === roles.Teacher && (
                                <button
                                    ...
                                    className="cursor-pointer rounded-lg bg-[#42C2FF] px-7 py-3 font-medium text-white transition hover:bg-[#42C2FF]/90"
                                >
                                    Apply as Teacher
                                </button>
                            )}
