        ...
        <>
            <nav className={`fixed top-0 z-50 w-full bg-white dark:bg-[#222831] shadow-sm dark:shadow-white/20 transition-transform duration-300 ease-in-out ${showNavbar ? 'translate-y-0' : '-translate-y-full'}`}>
                <div className="relative mx-auto flex items-center justify-between px-6 py-4">
                    ...
                    <div className="relative flex items-center space-x-4">
                        ...
                        <span className="hidden md:block font-medium text-[#3ABEFF]">
                        ...
                        <div className="relative" ref={dropdownRef}>
                            ...
                            {dropdownOpen && (
                                <div className="absolute right-0 mt-3 w-48 rounded-xl border bg-white dark:bg-[#242124] p-2 shadow-lg">
                                    {isLoggedIn ? (
                                        <>
                                            <button
                                            ...
                                            <button
                                                ...
                                                className="w-full rounded-lg px-3 py-2 text-left text-sm text-red-500 hover:bg-gray-100 dark:hover:bg-white/20"
                                            >
                                                Logout
                                            </button>
                                        </>
            ...
            <div className="fixed right-0 bottom-0 left-0 z-50 flex justify-around border-t dark:border-white/30 bg-white dark:bg-[#222831] py-3 shadow-lg lg:hidden">
                ...
                <button onClick={() => router.get(route('list-course'))} className="group flex flex-col items-center">
                    ...
                    <span className={`mt-1 text-xs ${currentRoute === 'list-course' ? 'font-semibold text-[#3ABEFF]' : 'text-[#3ABEFF]'}`}>
                        Course
                    </span>
                </button>
