    ...
    <div className="relative z-0 w-full group">
      {type === "textarea" ? (
        <textarea
          ...
          className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 
                     ...
                     dark:focus:border-[#42C2FF] focus:outline-none focus:ring-0 focus:border-[#42C2FF] peer"
          placeholder=" "
          autoComplete="off"
          tabIndex={tabIndex}
          disabled={disabled}
        ...
        <input
          ...
          className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 
                     border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 
                     dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-[#42C2FF] peer"
          placeholder=" "
          autoComplete="off"
          tabIndex={tabIndex}
          disabled={disabled}
      ...
      <label
        ...
        className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 
                   ...
                   peer-focus:text-[#42C2FF] peer-focus:dark:text[#42C2FF]
