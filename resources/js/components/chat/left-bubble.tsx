            ...
            <div className="group relative flex flex-row">
                <div
                    className={clsx(
                        ...
                        'rounded-md border dark:border-white/20 shadow-sm dark:shadow-white/20 py-2 pr-3 pl-3 text-xs text-gray-800 dark:text-white lg:text-sm',
                    )}
                >
                    {/* Replied Chat */}
                    {message.reply && !message.message_deleted_at && (
                        <div className="mb-1.5 max-w-full rounded border-l-4 border-green-300 bg-gray-200/50 dark:bg-gray-700/50 px-2 py-1.5">
                    ...
                    {!message.message_deleted_at && (
                        <div className="flex items-center justify-end lg:-mt-2.5 lg:-mr-9">
                            <div className="text-[9px] text-gray-400/70 dark:text-white/60 lg:text-[10px]">{message.sent_at}</div>
                        </div>
                    )}
                </div>
                ...
                {!message.message_deleted_at && (
                    <div className="relative">
                        <div className="absolute top-0 right-0 bottom-0 -mr-8 flex flex-row items-center justify-center text-xs text-gray-700 dark:text-white/90 opacity-0 group-hover:opacity-100">
