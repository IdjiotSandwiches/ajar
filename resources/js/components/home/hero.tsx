...
export default function HeroSection() {
  return (
    <section className="py-14 px-6 md:px-12 lg:px-20 flex flex-col md:flex-row items-center justify-between gap-12 bg-white cursor-default">
      <div className="md:w-1/2 space-y-6">
        <h1 className="text-3xl md:text-4xl font-bold text-[#42C2FF] leading-snug">
        ...
        <div className="flex w-full max-w-md bg-[#42C2FF]/50 rounded-lg shadow-sm overflow-hidden">
          ...
          />
          <button className="bg-[#42C2FF] text-white px-6 py-2 font-medium hover:bg-[#42C2FF]/90 cursor-pointer">
            Search
          </button>
        </div>
      </div>
