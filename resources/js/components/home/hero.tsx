...
export default function HeroSection() {
    ...
    return (
        <section className="flex cursor-default flex-col items-center justify-between gap-12 bg-white dark:bg-[#222831] px-6 py-14 md:flex-row md:px-12 lg:px-20">
            <div className="space-y-6 md:w-1/2">
                <h1 className="text-3xl leading-snug font-bold text-[#3ABEFF] md:text-4xl">
                ...
                <div className="flex w-full max-w-md overflow-hidden rounded-lg bg-[#3ABEFF]/50 shadow-sm">
                    <input
                        ref={inputRef}
                        type="text"
                        value={search}
