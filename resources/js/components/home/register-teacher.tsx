...
export default function BecomeTeacherSection() {
  return (
    <section className="pt-4 pb-8 md:pt-8 md:pb-16 px-4 sm:px-6 md:px-12">
      <div className="w-full">
        <div className="rounded-lg overflow-hidden flex flex-col lg:flex-row items-stretch bg-white dark:bg-[#222831] shadow-md dark:shadow-[#ffffff]/20 min-h-[320px]">
          <div className="w-full lg:w-2/3 p-6 sm:p-8 md:p-10 lg:p-12 flex flex-col justify-center gap-y-3">
            <h2 className="font-bold text-gray-800 dark:text-white mb-4 text-2xl sm:text-2xl md:text-2xl lg:text-3xl">
              Interested in becoming a Teacher at Ajar?
              <br />
              <span className="text-[#3ABEFF]">Register now!</span>
            </h2>

            <p className="text-gray-600 dark:text-white/80 mb-6 sm:mb-8 leading-relaxed max-w-4xl text-sm sm:text-base md:text-sm lg:text-base">
