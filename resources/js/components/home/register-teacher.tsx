...
export default function BecomeTeacherSection() {
    return (
        <section className="bg-white px-4 pt-4 pb-8 sm:px-6 md:px-12 md:pt-8 md:pb-16">
            <div className="w-full">
                <div className="flex min-h-[320px] flex-col items-stretch overflow-hidden rounded-lg bg-white shadow-md lg:flex-row">
                    <div className="flex w-full flex-col justify-center gap-y-3 p-6 sm:p-8 md:p-10 lg:w-2/3 lg:p-12">
                        <h2 className="mb-4 text-2xl font-bold text-gray-800 sm:text-2xl md:text-2xl lg:text-3xl">
                            Interested in becoming a Teacher at Ajar?
                            <br />
                            <span className="text-[#3ABEFF]">Register now!</span>
                        </h2>

                        <p className="mb-6 max-w-4xl text-sm leading-relaxed text-gray-600 sm:mb-8 sm:text-base md:text-sm lg:text-base">
