...
export default function Filter({ schema, onChange }: Props) {
    ...
    const renderField = (field: FilterFieldConfig) => {
        const baseClass =
            'w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-700 dark:text-white ' +
    ...
    return (
        <div className="rounded-2xl bg-white/90 dark:bg-[#222831]/90 p-4 border dark:border-white/90 shadow-sm dark:shadow-[#ffffff]/20 backdrop-blur-sm sm:p-6">
