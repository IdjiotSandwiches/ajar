                    ...
                    <ul className="space-y-2">
                        {MENU.map((item) => {
                            const isParentActive =
                                ...
                                item.children?.some((c) => isRouteActive(c.route));
