...
export default function TeacherProfileCard({ teacher }: any) {
    ...
    return (
        <div className="rounded-2xl bg-[#3ABEFF] dark:bg-[#222831] p-1 shadow-lg">
            <div className="rounded-2xl bg-white p-0.5">
                <div className="relative flex flex-col items-center overflow-hidden rounded-2xl bg-[#3ABEFF] dark:bg-[#222831] p-6 text-center">
